...
function addItineraryItem() {
  ...
  activityElement.innerHTML = `
                ...
                <button class="delete-activity" onclick="deleteActivity(${
                  activities.length - 1
...
function renderItineraryList() {
  ...
  activities.forEach((activity, index) => {
    ...
    activityElement.innerHTML = `
                    ...
                    <div class="activity-cost">₹${activity.cost.toFixed(
                      2
                    )}</div>
...
function generatePackingList() {
  ...
  if (!tripType || !weather) {
    document.getElementById("packingList").innerHTML =
      "<p>Select trip type and weather to generate packing list</p>";
    return;
  }
  ...
  packingListHTML += `
                <div class="packing-category">
                    ...
                    <div class="packing-items">
                        <div class="packing-item"><i class="fas fa-check"></i> ${Math.ceil(
                          duration / 2
                        )} T-shirts</div>
                        <div class="packing-item"><i class="fas fa-check"></i> ${Math.ceil(
                          duration / 3
...
function addDocument() {
  ...
  documentElement.innerHTML = `
    ...
    type.charAt(0).toUpperCase() + type.slice(1)
                ...
                <button class="delete-doc" onclick="deleteDocument(${
                  documents.length - 1
                })"><i class="fas fa-trash"></i></button>
            `;
...
function convertCurrency() {
  ...
  document.getElementById(
    "conversionResult"
  ).textContent = `${amount} INR = ${converted} ${toCurrency}`;
}
...
window.findRoute = function () {
  ...
  if (!from || !to) {
    resultDiv.innerHTML =
      '<div class="alert">Please enter both locations.</div>';
    return;
  }
...
const galleryData = [
  {
    ...
    description:
      "Famous for its whitewashed houses with blue domes, breathtaking sunsets, and crystal-clear waters. Santorini is a dream destination for romance and relaxation.",
    region: "europe",
    bestTime: "Apr-Oct",
    rating: 4.9,
  },
  {
    ...
    description:
      "This 15th-century Inca citadel is located high in the Andes Mountains. Often referred to as the 'Lost City of the Incas', it's one of the most iconic archaeological sites in the world.",
    region: "americas",
    bestTime: "May-Sep",
    rating: 4.8,
  },
  {
    ...
    description:
      "Known for its classical Buddhist temples, gardens, imperial palaces, and traditional wooden houses. Kyoto is especially beautiful during cherry blossom season.",
    region: "asia",
  ...
  },
  {
    ...
    description:
      "Famous for its annual migration of over 1.5 million wildebeest and 250,000 zebras. The park offers one of the most spectacular wildlife experiences on the planet.",
    region: "africa",
    bestTime: "Jun-Oct",
    rating: 4.8,
  },
  {
    ...
    description:
      "The world's largest coral reef system composed of over 2,900 individual reefs and 900 islands. A paradise for divers and marine life enthusiasts.",
    region: "oceania",
    bestTime: "Jun-Oct",
    rating: 4.7,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1514890547357-a9ee288728e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    description:
      "Built on more than 100 small islands in a lagoon in the Adriatic Sea. Known for its canals, gondolas, and stunning Renaissance architecture.",
    region: "europe",
  ...
  },
  {
    ...
    description:
      "The largest religious monument in the world, originally constructed as a Hindu temple. Its intricate carvings and majestic scale are breathtaking.",
    region: "asia",
    bestTime: "Nov-Feb",
    rating: 4.8,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1500581276021-a4bbcd0050c5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    description:
      "Canada's oldest national park, known for its turquoise glacial lakes, majestic mountains, and abundant wildlife. A paradise for outdoor enthusiasts.",
    region: "americas",
  ...
  },
  {
    ...
    description:
      "Famous for its turquoise lagoon protected by a coral reef and surrounded by sand-fringed motus (islets). The ultimate luxury island getaway.",
    region: "oceania",
    bestTime: "May-Oct",
    rating: 4.9,
  },
  {
    ...
    description:
      "One of the largest and most famous waterfalls in the world. Locally known as 'Mosi-oa-Tunya' or 'The Smoke that Thunders'.",
    region: "africa",
  ...
  },
  {
    ...
    description:
      "A steep-sided canyon carved by the Colorado River, it's 277 miles long, up to 18 miles wide and over a mile deep. A geological wonder that leaves visitors in awe.",
    region: "americas",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1519817914152-22d216bb9170?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    description:
      "The Aurora Borealis is a natural light display in the Earth's sky, predominantly seen in high-latitude regions. Iceland offers some of the best viewing opportunities.",
    region: "europe",
    bestTime: "Sep-Mar",
    rating: 4.9,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1519817914152-22d216bb9170?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    description:
      "Turquoise waters, bioluminescent beaches (Havelock Island), coral reefs, and historic Ross Island.",
    region: "asia",
    bestTime: "Nov-May",
    rating: 4.4,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1519817914152-22d216bb9170?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
    description:
      "Whitehaven Beach’s silica sand, sailing tours, Heart Reef flyovers.Reef sharks, sea turtles.",
    region: "australia",
    bestTime: "May-Sep",
    rating: 4.1,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1590523278191-995cbcda646b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
    description:
      "Paradise of coral atolls with luxury resorts and vibrant marine life.",
    region: "asia",
    category: "islands",
    bestTime: "Nov-Apr",
    rating: 4.8,
  },
  {
    ...
    location: "Thailand",
    image:
      "https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
    description:
      "Dramatic limestone cliffs and crystal-clear waters in the Andaman Sea.",
    region: "asia",
    category: "islands",
    bestTime: "Nov-Apr",
    rating: 4.7,
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1508973379184-7517410fb0bc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80",
    description:
      "Southern Lights - nature's spectacular light show in the Tasmanian sky.",
    region: "australia",
    category: "nature",
    bestTime: "May-Aug",
    rating: 4.9,
